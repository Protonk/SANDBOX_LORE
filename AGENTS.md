...
- Be explicit about uncertainty and evidence tiers (bedrock / mapped-but-partial / substrate-only); cite mapping paths from `book/graph/concepts/BEDROCK_SURFACES.json`.
