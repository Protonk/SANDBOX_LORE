...
* **Role:** PolicyGraph primitive (unit of “what is being attempted”).
* **Concrete handles:**
...
* **Role:** PolicyGraph predicate (condition on an operation’s context).
* **Concrete handles:**
...
* **Role:** PolicyGraph combinator (boolean logic over filters).
* **Concrete handles:**
...
* **Role:** PolicyGraph outcome (what the sandbox finally does).
* **Concrete handles:**
...
* **Role:** PolicyGraph decoration (adjusts semantics of a decision).
* **Concrete handles:**
...
* **Role:** PolicyGraph element (atomic step in evaluation).
* **Concrete handles:**
...
* **Role:** PolicyGraph structure (the full compiled policy for a profile).
* **Concrete handles:**
