...
Source: `book/experiments/vocab-from-cache/`. Treat these files as read-only, versioned mappings for this host when interpreting compiled profiles, op-tables, and anchor/field2 results.
