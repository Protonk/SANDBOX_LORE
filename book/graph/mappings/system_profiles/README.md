...
- CARTON manifest: `book/api/carton/CARTON.json` freezes the hashes/paths for Sonoma 14.4.1 system profile digests and their validation IR as part of the CARTON set the textbook and API read.
