...
- SUBSTRATE snapshot: `book/graph/substrate/SUBSTRATE_2025-v1.json` freezes the hashes/paths for Sonoma 14.4.1 system profile digests and their validation IR.
