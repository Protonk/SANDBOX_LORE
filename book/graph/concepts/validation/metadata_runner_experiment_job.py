...
def run_metadata_runner_job():
    ...
    observations = runtime_events.normalize_metadata_runner_results(results_doc, runner_info=runner_info)
    IR_PATH.parent.mkdir(parents=True, exist_ok=True)
    IR_PATH.write_text(json.dumps([runtime_events.serialize_observation(o) for o in observations], indent=2, sort_keys=True))
