...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    ap.add_argument(
        "--index",
        type=Path,
        default=Path("book/experiments/libsandbox-encoder/out/network_matrix/index.json"),
        help="Network matrix index JSON (for section offsets)",
    )
    ap.add_argument(
        "--out",
        type=Path,
        default=Path("book/experiments/libsandbox-encoder/out/network_matrix/encoder_write_record_map.json"),
