...
DYLD_SLICES = [
    ...
    REPO_ROOT / "book/graph/mappings/dyld-libs/usr/lib/system/libsystem_sandbox.dylib",
]
...
def parse_args(argv: Optional[Sequence[str]] = None) -> argparse.Namespace:
    default_out = REPO_ROOT / "book/experiments/gate-witnesses/out/message_filter_xrefs.json"
