...
OUT_PATH = REPO_ROOT / "book/experiments/hardened-runtime/other_runtime_inventory.json"
...
IN_REPO_ITEMS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "paths": ["book/experiments/sandbox-init-params"],
    ...
    },
    {
        "id": "runtime-mappings",
        "paths": [
            "book/graph/mappings/runtime",
            "book/graph/mappings/runtime_cuts",
        ],
        "category": "mapping",
    ...
    },
    {
        ...
        "paths": ["book/api/runtime_tools", "book/api/runtime_harness"],
        "category": "tooling",
    ...
    },
    {
        ...
        "paths": ["book/experiments/mac-policy-registration"],
        "category": "tracing",
...
EXTERNAL_ITEMS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "url": "https://man.freebsd.org/cgi/man.cgi?manpath=macOS+14.8&query=sandbox-exec&sektion=1",
...
def _rg_files(pattern: str) -> Iterable[Path]:
...
def collect_keyword_hits() -> Dict[str, List[str]]:
    hits: Dict[str, List[str]] = {}
    if not _rg_available():
        return hits
    for keyword in KEYWORDS:
        for path in _rg_files(keyword):
...
def main() -> int:
    hits = collect_keyword_hits()
    assigned = assign_hits(IN_REPO_ITEMS, hits)
    payload = {
        "schema_version": SCHEMA_VERSION,
        "world_id": load_world_id(),
        "generated_by": "book/experiments/hardened-runtime/build_other_runtime_inventory.py",
        "keywords": KEYWORDS,
