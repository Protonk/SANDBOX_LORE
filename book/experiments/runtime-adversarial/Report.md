...
- Harness: `book.api.runtime_tools.harness.runner.run_matrix` + runtime-checks shims; compile/decode via `book.api.profile_tools` and `book.api.profile_tools.decoder`.
