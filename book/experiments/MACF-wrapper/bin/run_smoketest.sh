...
CAPTURE="$REPO_ROOT/book/experiments/MACF-wrapper/capture.py"
...
run_capture() {
  ...
  desc="$3"
  cmd="$4"
  raw_out="$REPO_ROOT/book/experiments/MACF-wrapper/out/raw/${run_id}.log"
  json_out="$REPO_ROOT/book/experiments/MACF-wrapper/out/json/${run_id}.json"
...
TEST_DIR="$REPO_ROOT/book/experiments/MACF-wrapper/out/tmp"
mkdir -p "$TEST_DIR"
