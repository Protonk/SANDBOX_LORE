...
This project is a curated, local-only universe for understanding the macOS sandbox circa 2025, with an emphasis on:
...
Using this layer we build an example-driven synthetic guide for human and machine agents covering the sandbox on macOS. 
...
- `book/` – The Cathedral of Shit
  ...
  - `graph/` – Machine-readable mappings of concepts and artifacts:
    - `graph/concepts/` – concept inventory and validation.
